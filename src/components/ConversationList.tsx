          ...
          >
            <div className="flex items-start space-x-3">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-sm">
                  {conv.avatar}
                </div>
                {conv.unread > 0 && (
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <div className="text-xs text-gray-600 truncate font-medium">{conv.item}</div>
                </div>
